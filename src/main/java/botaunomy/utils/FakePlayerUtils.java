...
public class FakePlayerUtils {
     ...
     */
    public static void setupFakePlayerForUse(FakePlayer player, BlockPos pos, EnumFacing direction, ItemStack toHold, boolean sneaking) {
     ...
     */
    public static ItemStack rightClickInDirection(FakePlayer player, World world, BlockPos pos, EnumFacing side, IBlockState sourceState, RayTraceResult toUse) {
     ...
     * @return The remainder of whatever the player was holding.  This should be set back into the tile's stack handler or similar.
     */
    public static ItemStack leftClickInDirection(FakePlayer player, World world, BlockPos pos, EnumFacing side, IBlockState sourceState, RayTraceResult toUse) {
     ...
     */
    public static RayTraceResult traceEntities(FakePlayer player, Vec3d base, Vec3d target, World world) {
     ...
     */
    public static boolean processUseEntity(FakePlayer player, Entity entity, @Nullable RayTraceResult result, CPacketUseEntity.Action action) {
        if (entity != null) {
